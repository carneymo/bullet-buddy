...
class Word extends React.Component {
  ...
  render() {
    ...
    if (this.isNotEditable(word)) {
      ...
      return (
        <span key={"word" + this.props.key} className={c}>
          {word}
        </span>
      );
    }
    ...
    return (
      ...
      >
        ...
        <span
          key={"popup" + this.props.key}
          className={this.state.open ? "popuptext show" : "popuptext"}
        >
        ...
        <div className="bullet-editor" style={{ width: this.props.width }}>
          {
            ...
            this.state.bullets.map((bullet, i) => {
              ...
              return (
                ...
                >
                  <Bullet
                    key={"bullet" + index.toString() + i.toString()}
                    text={bullet}
    ...
    return (
      <div>
        ...
        >
          <p>
            XX. AMAZING BULLETS{" "}
            <mark>(Dont forget to copy to the right place!)</mark>
          </p>
          <div ref={this.ref}>
            {
